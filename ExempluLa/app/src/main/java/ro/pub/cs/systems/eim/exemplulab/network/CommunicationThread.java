package ro.pub.cs.systems.eim.exemplulab.network;
...
import ro.pub.cs.systems.eim.exemplulab.Constants;
import ro.pub.cs.systems.eim.exemplulab.Information;
import ro.pub.cs.systems.eim.exemplulab.Utilities;
    ...
    public void run() {
        ...
        try {
            ...
            if (ip == null || ip.isEmpty()) {
                Log.e("[PracticalTest02]", "[COMMUNICATION THREAD] Error receiving parameters from client (information type!");
                return;
            }
...
//            JSONArray infoArray = content.getJSONArray(Constants.WEATHER);
//            JSONObject info;
//            String condition = "";
//            for (int i = 0; i < infoArray.length(); i++) {
//                info = infoArray.getJSONObject(i);
//                condition += info.getString(Constants.MAIN) + " : " + info.getString(Constants.DESCRIPTION);
//
...
//            }
            ...
            information = new Information(countryName, continentName, countryCode, Double.parseDouble(longitude),
